...
using Server.STS.Identity.Configuration;
using Server.STS.Identity.Configuration.ApplicationParts;
using Server.STS.Identity.Configuration.Constants;
using Server.STS.Identity.Configuration.Interfaces;
using Server.STS.Identity.Helpers.Localization;
...
namespace Server.STS.Identity.Helpers
{
